...
public class CustomEditorBase : Editor
{
	...
	private class ReorderableListProperty
	{
		...
		private void drawElement(Rect rect, int index, bool active, bool focused)
		{
			...
			{
				GUIStyle InventoryHeaderStyle = new GUIStyle( EditorStyles.label );
				InventoryHeaderStyle.alignment = TextAnchor.UpperLeft;
				EditorGUI.LabelField(rect, this._property.GetArrayElementAtIndex(index).displayName, InventoryHeaderStyle);
			}
			//rect.height = 16;
